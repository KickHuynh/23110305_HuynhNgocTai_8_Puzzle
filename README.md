...
Dự án đã triển khai và thử nghiệm thành công nhiều thuật toán tìm kiếm và tối ưu để giải bài toán 8 puzzle – một bài toán cổ điển nhưng có tính ứng dụng cao trong lĩnh vực trí tuệ nhân tạo. Qua quá trình đánh giá, nhóm tìm kiếm có thông tin, đặc biệt là thuật toán A* sử dụng heuristic khoảng cách Manhattan, cho thấy hiệu quả cao nhất về tốc độ và tính tối ưu lời giải. Trong khi đó, các thuật toán không có thông tin như BFS và IDS đảm bảo tìm ra lời giải nhưng tiêu tốn nhiều bộ nhớ và thời gian. Các thuật toán tìm kiếm cục bộ như Hill Climbing, Genetic Algorithm, Beam Search hay Simulated Annealing lại mang lại tốc độ xử lý nhanh và tiết kiệm tài nguyên hơn, song dễ bị mắc kẹt tại các cực trị cục bộ và không đảm bảo tối ưu toàn cục. Học tăng cường (Reinforcement Learning), với đại diện là Q-Learning, cũng được thử nghiệm và cho thấy tiềm năng trong các môi trường phức tạp, tuy nhiên việc học diễn ra chậm do không gian trạng thái lớn và thiếu mô hình môi trường rõ ràng. Ngoài ra, việc áp dụng các phương pháp CSP và tìm kiếm trong môi trường quan sát một phần chưa mang lại hiệu quả cao vì không phù hợp với bản chất tĩnh và xác định của bài toán.

## 3.2. Khó khăn
Dự án cũng gặp phải một số khó khăn đáng kể, như việc xử lý không gian trạng thái lớn (181,440 cấu hình khả thi), đòi hỏi bộ nhớ và thời gian xử lý cao, đặc biệt với các thuật toán duyệt toàn bộ. Bên cạnh đó, việc xây dựng hàm heuristic hiệu quả, điều chỉnh tham số của các thuật toán cục bộ, và huấn luyện học tăng cường cũng là những thách thức cần nhiều thử nghiệm và tinh chỉnh.

## 3.3. Hướng phát triển
Từ những kết quả trên, hướng phát triển trong tương lai có thể bao gồm việc kết hợp các phương pháp tìm kiếm truyền thống với học máy, ứng dụng Deep Reinforcement Learning để vượt qua giới hạn Q-Table, tối ưu hóa heuristic bằng các mô hình học sâu, mở rộng nghiên cứu sang các biến thể khó hơn như 15-puzzle, và phát triển giao diện mô phỏng trực quan giúp minh họa rõ hơn quá trình tìm kiếm. Nhìn chung, bài toán 8 puzzle đã cung cấp một nền tảng vững chắc để đánh giá toàn diện hiệu quả của các thuật toán tìm kiếm, đồng thời mở ra nhiều tiềm năng nghiên cứu và ứng dụng trong các bài toán thực tế phức tạp hơn.
